        ...
        _.each(productAndVersionBooks, function(bookElement) {
            var bookListing = jQuery(
                '<div> \
                    ...
                    ' + (bookElement.buildSuccess?'<span class="pficon pficon-ok"></span>':'<span class="pficon-layered"><span class="pficon pficon-error-octagon"></span><span class="pficon pficon-error-exclamation"></span></span>') + '\
                    </h2> \
                    <div class="btn-group"> \
