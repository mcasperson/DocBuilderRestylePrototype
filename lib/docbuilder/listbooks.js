        ...
        var productAndVersionHeading = jQuery(
                '<div>\
                     <h1 class="book-list-title">\
                         <a data-toggle="collapse" data-target="#' + elementId + '" class="collapsed">' + _.escape(productName) + ' ' + _.escape(versionName) + '</a>\
                     </h1>\
             </div>');

        var bookList = jQuery('<div id="' + elementId + '" class="panel-collapse collapse"></div>');
