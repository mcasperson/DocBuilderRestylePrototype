...
jQuery(init_filter);
jQuery(function() {build_table(data)});
...
function build_table(data) {
    ...
    productsAndVersions = _.filter(productsAndVersions, function(element) {
        if (productFilter && productFilter.length != 0 && !element.productRaw.toLowerCase().match(productFilter.toLowerCase())) {
            return false;
        }

        if (versionFilter && versionFilter.length != 0 && !element.versionRaw.toLowerCase().match(versionFilter.toLowerCase())) {
            return false;
        }
                ...
                '<div> \
                    ...
                    <div class="btn-group bookMenu"> \
                        ...
                        <ul class="dropdown-menu" role="menu"> \
                            <li><a href="' + bookElement.idRaw + '">View Spec</a></li> \
